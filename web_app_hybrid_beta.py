...
def main():
    ...
    with col2:
        ...
        if 'processing_success' not in st.session_state or not st.session_state.processing_success:
            ...
            **Supported Features:**
            ...
            # Show Quick Stats if there are results
    ...
    # Configuration and processing section (only shown after file upload)
